...
3.  **Tableau de Bord et Gestion des Employés (Frontend)** [~]
    ...
    *   **Avancement :**
        *   [x] Sécurisation de la route `/dashboard` (correction).
        *   [ ] Mise à jour du service `api.ts` avec les fonctions pour les entreprises et employés.
        *   [ ] Construction de la page `DashboardPage.tsx` pour afficher les données.
        *   [ ] Création des composants React (`EmployeeList`, `EmployeeForm`) pour la gestion.
