...
// Cela gérera toutes les routes commençant par /api/companies/:companyId/employees
router.use('/:companyId/employees', employeesRouter);

// Monter le routeur des analytics pour les routes imbriquées
// Cela gérera toutes les routes commençant par /api/companies/:companyId/analytics
router.use('/:companyId/analytics', analyticsRouter);

// Monter le routeur des notes de frais pour les routes imbriquées
// Cela gérera toutes les routes commençant par /api/companies/:companyId/expense-reports
